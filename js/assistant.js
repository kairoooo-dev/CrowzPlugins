...
(() => {
    ...
    const KNOWLEDGE = [
        ...
        },
        {
            ...
            answer: () => `🔐 <b>Licenses:</b> a few plugins here are license-gated. When you hit <b>Download</b> on one of those, the site asks for a license key (format <code>CROWZ-XXXXX-XXXXX-XXXXX</code>) that unlocks the jar. Keys are handed out by the plugin author, never expire, and can be revoked at any time. No key yet? Ask whoever runs the server — they manage them in the license manager.`
        },
        {
        ...
        },
        {
            ...
            answer: () => `I'm <b>Crowz Assistant</b> 🤖 — a local AI assistant built into the Crowz-Plugins hub. I run 100% in your browser (no data leaves your device) and I know every plugin in this hub inside out.`
        },
        {
    ...
    function openPanel() {
        ...
        if (!chat.children.length) {
            setTimeout(() => addMessage('Hey! 👋 I\'m <b>Crowz Assistant</b>. Ask me about any plugin, installation steps, or what to use for your server type!'), 300);
        }
    }
    function closePanel() {
